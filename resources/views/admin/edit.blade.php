                ...
                <div class="col-md-3">
                    ...
                    @endforeach
                        ...
                        <div class="c-form__group row">
                            ...
                            <div class="col-md-6">
                                <input placeholder="メールアドレス" id="email" type="email" class="c-form__group--control @error('email') c-form__error--background @enderror" name="email" value="{{ $admin->email }}" required autocomplete="email">
