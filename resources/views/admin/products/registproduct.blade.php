                    ...
                    <form method="post" action="{{ route('admin.products.create') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="price">価格（円）</label>
                                <input placeholder="999,999以下" id="price" type="number" min="0" max="999999" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}"  required autocomplete="price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input placeholder="ファイル" accept="image/*" id="photofile" type="file" class="form-control @error('photofile') is-invalid @enderror" name="photofile" required autocomplete="new-photofile">
