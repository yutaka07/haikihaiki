...
<head>
    ...
    <meta name="description" content="haikishareのコンビニオーナーの商品一覧ページです。">
...
<body>
    <div id="app">
                    ...
                    <div class="c-menu__content">
                        ...
                        <ul class="c-menu__drawer">
                            ...
                            <li class="c-menu__item">
                                ...
                                <a class="c-menu__link" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
        ...
        <main class="main">
            <div id="app3">
                <router-view :products="{{ $products }}" :prefectures="{{ $prefectures }}" :admins="{{ $admins }}"></router-view>
            </div>
        </main>
